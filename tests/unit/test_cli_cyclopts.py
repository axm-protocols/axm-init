...
class TestCommandsRegistered:
    ...
    def test_audit_command_not_yet(self) -> None:
        """audit command does not exist yet (Phase C)."""
        # Will flip to assertTrue in Phase C
        assert "audit" not in self._command_names()
